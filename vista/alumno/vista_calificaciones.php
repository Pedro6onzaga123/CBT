...
<div class="col-md-8" id="divtablanotas" hidden>
  <div class="box box-warning">
    ...
    <!-- /.box-header -->
    <div class="box-body">
      <button  class="btn btn-default btn-sm " onclick="printNotas(this)"><i id="icono" class="fa fa-fw fa-print"></i></button>

      <div class=" table-responsive" ><br>
        <table id="tabla_notas "style="width: 100%;margin-top: -30px;" class="table table-bordered table-sm">
